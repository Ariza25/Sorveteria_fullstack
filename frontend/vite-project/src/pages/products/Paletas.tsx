...
const Picoles = () => {
  ...
  const categoryId = "65e6341efe6ec441efb38553";
            ...
            return (
              ...
              >
                <div>
                  <img
                    src={imageUrl}
                    className="w-[260px] h-[200px] cursor-pointer"
                    alt={product.name}
                  />
                  {product.stock === false && (
                    <div className="absolute top-0 left-0 w-[259px] h-[200px] bg-red-500 bg-opacity-50 flex items-center justify-center">
